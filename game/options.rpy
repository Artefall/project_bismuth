...
define config.version = "0.0.1-poc"
...
define gui.about = _p("""
    Проект Bismuth это визуальная новелла. Обо всем и ни о чем. Абстрактная, бесмыссленная, беспощадная.
""")
...
define config.save_directory = "project_bismuth-1771648005"
